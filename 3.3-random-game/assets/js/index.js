...
Дизайн игры был полностью разработан мной.
...
PS: то что змейка может врезаться в себя разворотом головы на 180 градусов- не баг, а фича. Не нужно было пытаться свернуть ей шею.`);
